...
export function subscribeMenuInput(fn) {
  listeners.add(fn);
  return () => listeners.delete(fn);
}

const heldEdge = {}; // tracks which actions are already "down" for edge detection across sources
...
export function touchRelease(action) {
